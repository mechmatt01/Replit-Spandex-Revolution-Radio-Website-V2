...
## Changelog
- June 21, 2025: Reorganized floating player layout - moved LIVE indicator to left side next to "Live Stream" text, moved volume controls next to play button on right side
