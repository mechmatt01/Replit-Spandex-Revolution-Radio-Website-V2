...
- June 29, 2025: RESTORED dark theme site appearance - fixed all section backgrounds to proper black styling (HomePage, About, Schedule, Contact, Submissions, InteractiveListenerMap, Subscribe sections), maintained radio selection button border refinements (100% opacity, 2px width, 15px radius), preserved LIVE IN indicator styling with 100% text opacity and 80% dot opacity, ensured consistent dark metal theme aesthetic across entire application
