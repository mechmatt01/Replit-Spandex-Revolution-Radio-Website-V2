...
- June 23, 2025: Fixed metadata system to only show actual stream information instead of simulated track rotation, moved floating player to left side with clean design, positioned live chat icon on right side at matching height, fixed LIVE indicator to red pulsing dot, removed extra text elements, improved volume control spacing
