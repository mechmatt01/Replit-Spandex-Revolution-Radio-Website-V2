...
- June 29, 2025: COMPLETED radio station selector styling fixes - implemented theme-colored button text and radio icon, light gray dropdown arrow (text-gray-400), dark background (bg-black/80) matching navigation dropdown, custom emoji icons for each station (🎵, 🔥, ⚡, 🤘, 🎸), theme-aware border colors, scrollable dropdown with selected station first, automatic closure on scroll events, volume indicator centering, improved visual hierarchy throughout interface
