...
- June 29, 2025: FINALIZED radio interface improvements - radio selection button border radius reduced to 11px, dropdown indicator properly animates upward when open/downward when closed, animated speaker icon enlarged 1.5x with improved vertical alignment, LIVE IN indicator text and dot both set to 90% opacity, countdown labels styled as light gray with 65% opacity, restored dark theme site appearance across all sections
