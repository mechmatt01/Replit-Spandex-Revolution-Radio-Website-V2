...
export default function Globe3D({ listeners = [], className = "" }: Globe3DProps) {
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-full overflow-hidden">
                    ...
                    <div className="absolute w-8 h-12 bg-green-600 rounded-full opacity-70 top-16 left-12" /> {/* North America */}
                    <div className="absolute w-6 h-8 bg-green-600 rounded-full opacity-70 top-24 left-20" /> {/* South America */}
                    <div className="absolute w-10 h-8 bg-green-600 rounded-full opacity-70 top-12 left-32" /> {/* Europe/Africa */}
                    <div className="absolute w-12 h-10 bg-green-600 rounded-full opacity-70 top-20 left-44" /> {/* Asia */}
                    <div className="absolute w-6 h-6 bg-green-600 rounded-full opacity-70 top-40 left-48" /> {/* Australia */}
                  </div>
