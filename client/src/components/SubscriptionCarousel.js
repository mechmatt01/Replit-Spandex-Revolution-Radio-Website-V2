...
export default function SubscriptionCarousel() {
    ...
    return (_jsxs("div", { className: "relative w-full max-w-6xl mx-auto px-4", children: [_jsxs("div", { className: "relative perspective-1000 subscription-carousel-container overflow-visible py-2 sm:py-4 md:py-6 lg:py-8", style: {
                    minHeight: '700px',
                    height: 'auto'
                }, children: [_jsx("button", { onClick: handlePrevious, className: "absolute left-2 top-1/2 transform -translate-y-1/2 z-10 bg-black/50 hover:bg-black/70 rounded-full p-2 transition-colors", disabled: isAnimating, title: "Previous subscription", children: _jsx(ChevronLeft, { className: "w-8 h-8 text-white hover:scale-110 transition-transform drop-shadow-md" }) }), _jsx("button", { onClick: handleNext, className: "absolute right-2 top-1/2 transform -translate-y-1/2 z-10 bg-black/50 hover:bg-black/70 rounded-full p-2 transition-colors", disabled: isAnimating, title: "Next subscription", children: _jsx(ChevronRight, { className: "w-8 h-8 text-white hover:scale-110 transition-transform drop-shadow-md" }) }), _jsx("div", { className: "flex items-center justify-center h-full relative", children: _jsxs("div", { className: "relative w-full max-w-md", style: {
                                                        ...
                                                        background: `linear-gradient(135deg, ${currentTier.gradientStart}20, ${currentTier.gradientEnd}20)`,
                                                            ...
                                                            transitionDelay: `${index * 50}ms`,
                                                                ...
                                                                color: currentTheme === 'light-mode' ? 'rgba(0, 0, 0, 0.6)' : '#9ca3af'
                                                                    ...
                                                                    color: currentTheme === 'light-mode' ? 'rgba(0, 0, 0, 0.7)' : '#d1d5db'
                                                                }, children: perk }, index))) })] }) }), _jsx("div", { className: "mt-auto mb-3 sm:mb-4", children: _jsxs(Button, { className: "w-full py-3 sm:py-4 text-sm sm:text-base font-bold rounded-xl transform transition-all duration-300 hover:scale-105", style: {
                                                        background: `linear-gradient(135deg, ${currentTier.gradientStart}, ${currentTier.gradientEnd})`,
