...
export default function MetalThemeSwitcher() {
    ...
    return (_jsx("div", { className: "flex items-center gap-2", children: _jsxs(Popover, { open: isOpen, onOpenChange: setIsOpen, children: [_jsx(PopoverTrigger, { asChild: true, children: _jsxs(Button, { variant: "ghost", size: "sm", className: "flex items-center gap-2 hover:bg-opacity-20 theme-button-border", style: {
                        ...
                        border: `1px solid ${colors.border}`,
                                    ...
                                    return (_jsx(Button, { onClick: () => handleThemeClick(themeKey, themeConfig), variant: "ghost", className: `w-full justify-start p-3 h-auto transition-all duration-200 ${isActive ? "ring-2" : ""} ${isLocked ? "opacity-75" : ""}`, style: {
                                        ...
                                        border: "1px solid rgba(255, 255, 255, 0.18)",
                                            ...
                                            border: "1px solid rgba(255, 255, 255, 0.18)",
                                                                ...
                                                                setShowPremiumDialog(false);
                                                                setIsOpen(false);
                                                            }, className: "w-full font-semibold px-4 py-2 text-xs", style: {
