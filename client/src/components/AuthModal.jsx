    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (mode === "login") {
                ...
                await register(firstName, lastName, email, phoneNumber.replace(/[^\d]/g, ""), password);
                successToast({
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === "register" && (<>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="username" value={username} onChange={(e) => setUsername(e.target.value)} className="pl-10 bg-black/50   placeholder:text-gray-400 placeholder:opacity-50" style={{
                color: colors.text,
                borderColor: "#374151",
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400"/>
                      <Input id="firstName" value={firstName} onChange={(e) => setFirstName(e.target.value)} className="pl-10 bg-black/50   placeholder:text-gray-400 placeholder:opacity-50" style={{
                color: colors.text,
                borderColor: "#374151",
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400"/>
                      <Input id="lastName" value={lastName} onChange={(e) => setLastName(e.target.value)} className="pl-10 bg-black/50   placeholder:text-gray-400 placeholder:opacity-50" style={{
                color: colors.text,
                borderColor: "#374151",
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="phoneNumber" type="tel" value={phoneNumber} onChange={handlePhoneChange} className="pl-10 bg-black/50   placeholder:text-gray-400 placeholder:opacity-50" style={{
                color: colors.text,
                borderColor: "#374151",
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10 bg-black/50   placeholder:text-gray-400 placeholder:opacity-50" style={{
            color: colors.text,
            borderColor: "#374151",
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 bg-black/50   placeholder:text-gray-400 placeholder:opacity-50" style={{
            color: colors.text,
            borderColor: "#374151",
        }} onFocus={(e) => (e.currentTarget.style.borderColor = colors.primary)} onBlur={(e) => (e.currentTarget.style.borderColor = "#374151")} placeholder="Password" autoComplete={mode === "login" ? "current-password" : "new-password"} required/>
              </div>
            </div>
