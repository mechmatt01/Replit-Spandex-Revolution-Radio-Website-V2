...
export default function Features() {
    ...
    return (<section id="features" className="py-20 transition-colors duration-300" style={{ backgroundColor: colors.background }} aria-label="Platform features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-orbitron font-black text-4xl md:text-5xl mb-6" style={{
        ...
        <StaggeredAnimation className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" staggerDelay={50} direction="up">
          ...
          <div className="relative">
            ...
            <Card className="relative group cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl border-2 p-8 flex flex-col h-full enhanced-glow feature-container" style={{
        ...
        }} onClick={scrollToRadioPlayer} onMouseEnter={() => setHoveredFeature('streaming')} onMouseLeave={() => setHoveredFeature(null)}>
            <CardContent className="p-0 flex flex-col h-full">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 shadow-lg" style={{ backgroundColor: colors.primary }}>
                <Radio className="text-white h-8 w-8"/>
              </div>
              <h3 className="font-black text-2xl mb-4 h-16 flex items-center text-left" style={{ color: colors.text }}>
                24/7 Live Streaming
              </h3>
              <p className="font-semibold text-lg leading-relaxed mb-6 flex-grow text-left" style={{ color: colors.textMuted, minHeight: "4.5rem" }}>
                Non-stop old-school metal streaming with high-quality audio and
                minimal buffering.
              </p>
              <div className="flex items-center text-sm font-bold mt-auto text-left" style={{ color: colors.primary }}>
        ...
        }} onClick={() => scrollToSection("schedule")} onMouseEnter={() => setHoveredFeature('archives')} onMouseLeave={() => setHoveredFeature(null)}>
            <CardContent className="p-0 flex flex-col h-full">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 shadow-lg" style={{ backgroundColor: colors.primary }}>
        ...
        }} onClick={() => scrollToSection("map")} onMouseEnter={() => setHoveredFeature('map')} onMouseLeave={() => setHoveredFeature(null)}>
            <CardContent className="p-0 flex flex-col h-full">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 shadow-lg" style={{ backgroundColor: colors.primary }}>
        ...
        }} onClick={() => scrollToSection("subscribe")} onMouseEnter={() => setHoveredFeature('rebellion')} onMouseLeave={() => setHoveredFeature(null)}>
            <CardContent className="p-0 flex flex-col h-full">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 shadow-lg" style={{ backgroundColor: colors.primary }}>
              ...
              <p className="font-semibold mb-6 text-lg leading-relaxed flex-grow text-left" style={{ color: colors.textMuted }}>
                Join our premium membership for exclusive content, early access,
                and special perks.
              </p>
              <div className="flex justify-start">
                <Button className="font-bold text-lg px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 border-0 flex items-center" style={{
        ...
        }} onClick={() => scrollToSection("submissions")} onMouseEnter={() => setHoveredFeature('requests')} onMouseLeave={() => setHoveredFeature(null)}>
            <CardContent className="p-0 flex flex-col h-full">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 shadow-lg" style={{ backgroundColor: colors.primary }}>
        ...
        }} onClick={() => scrollToSection("shop")} onMouseEnter={() => setHoveredFeature('merch')} onMouseLeave={() => setHoveredFeature(null)}>
            <CardContent className="p-0 flex flex-col h-full">
              <div className="w-16 h-16 rounded-xl flex items-center justify-center mb-6 shadow-lg" style={{ backgroundColor: colors.primary }}>
