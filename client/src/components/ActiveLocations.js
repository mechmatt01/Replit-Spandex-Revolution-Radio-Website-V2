...
export default function ActiveLocations() {
    ...
    return (_jsxs("div", { className: "p-8 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl overflow-hidden", style: {
        ...
        }, children: [_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsx("h3", { className: "font-orbitron font-bold text-xl", style: { color: colors.text }, children: "\uD83C\uDF0D ACTIVE LOCATIONS" }), _jsxs("div", { className: "px-3 py-1 rounded-full text-sm font-semibold", style: {
