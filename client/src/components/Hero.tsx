  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-dark-bg via-dark-surface to-dark-bg">
        ...
        ></div>
        <div className="absolute inset-0 bg-gradient-to-r from-dark-bg/80 via-transparent to-dark-bg/80"></div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-2">Old School Metal • 24/7 Live Stream</p>
        ...
        {/* Now Playing Card */}
        <Card className="bg-dark-surface/80 border-dark-border backdrop-blur-sm max-w-md mx-auto mb-8">
          <CardContent className="p-6">
            <div className="flex items-center mb-4">
              <Music className="text-metal-orange mr-2 h-4 w-4" />
              <span className="text-gray-400 text-sm">NOW PLAYING</span>
            </div>
            <h3 className="font-bold text-lg mb-1">{currentTrack?.title || "Loading..."}</h3>
            <p className="text-gray-300">{currentTrack?.artist || "Artist"}</p>
            <p className="text-gray-500 text-sm">{currentTrack?.album || "Album"}</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12">
          ...
          <Button 
            ...
            variant="outline"
            className="border-2 border-metal-gold text-metal-gold hover:bg-metal-gold hover:text-dark-bg px-8 py-4 rounded-full font-bold text-lg transition-all duration-300"
          >
        ...
        {/* Countdown Timer */}
        <div className="mt-12">
          <p className="text-gray-400 mb-4">OFFICIAL LAUNCH COUNTDOWN</p>
          <div className="flex justify-center space-x-4 text-center">
            <Card className="bg-dark-surface border-dark-border p-4 min-w-[80px]">
