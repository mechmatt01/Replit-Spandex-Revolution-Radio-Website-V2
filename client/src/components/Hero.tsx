      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 pt-16">
        ...
        <div className="mt-8 mb-8">
          <div className="flex items-center justify-center mb-1">
            ...
            <div className="flex items-center gap-2 px-4 py-1 rounded-full text-lg font-bold shadow-none" style={{ backgroundColor: 'rgba(255, 255, 255, 0.2)' }}>
              <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse opacity-90"></div>
              <span className="text-red-500 opacity-90 animate-pulse">LIVE IN</span>
            </div>
          </div>
