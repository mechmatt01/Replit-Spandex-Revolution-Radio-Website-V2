...
export default function Hero() {
    ...
    return (<section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden -mt-16 pt-16">
      {/* Background with Theme-Aware Fade */}
      <div className="absolute inset-0 -top-16">
        {/* Background Image */}
        <div className="absolute inset-0 bg-cover bg-center opacity-20 dark:opacity-20 light:opacity-30" style={{
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 pt-8">
        <h1 className="font-orbitron font-black text-5xl md:text-8xl mb-8" style={{
        ...
        <p className="text-lg md:text-xl font-orbitron font-semibold mb-6 max-w-2xl mx-auto text-center" style={{ color: colors.textMuted }}>
        ...
        <div className="mb-8 flex flex-col justify-center items-center">
          <p className="font-orbitron font-black text-xl md:text-2xl mb-1" style={{ color: colors.primary }}>
            Old School Metal
          </p>
          <p className="font-orbitron font-black text-base md:text-lg" style={{ color: colors.primary }}>
            24/7 Live Stream
          </p>
        </div>
        ...
        <div className="mb-8" role="timer" aria-label="Live broadcast countdown">
          ...
          <div className="flex justify-center space-x-4 text-center mb-3">
            <div className="bg-card/40 backdrop-blur-sm p-4 min-w-[90px] rounded-xl transition-colors duration-300 flex flex-col items-center">
              ...
              <div className="text-xs opacity-65 font-semibold" style={{
          ...
          <div className="text-center mt-3">
            <p className="text-sm font-semibold opacity-80" style={{ color: colors.textMuted }}>
