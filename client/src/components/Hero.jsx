...
export default function Hero() {
    ...
    return (<section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 -top-16">
        {/* Background Image */}
        <div className="absolute inset-0 bg-cover bg-center opacity-25 dark:opacity-20 light:opacity-35" style={{
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 pt-12">
        ...
        <p className="text-lg md:text-xl font-orbitron font-semibold mb-6 max-w-2xl mx-auto text-center" style={{
        ...
        <div className="mb-8" role="timer" aria-label="Live broadcast countdown">
          ...
          <div className="text-center mt-3">
            <p className="text-sm font-semibold opacity-80" style={{
            color: currentTheme === 'light-mode' ? '#212936' : colors.textMuted
        }}>
