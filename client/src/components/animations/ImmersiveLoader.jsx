...
const ImmersiveLoader = ({ isLoading, children, type = 'fade', delay = 0, duration = 300 }) => {
    ...
    const Skeleton = () => (<div className="animate-pulse space-y-4">
      <div className="h-6 rounded-lg" style={{ backgroundColor: `${colors.surface}40` }}/>
      <div className="h-4 rounded-lg w-3/4" style={{ backgroundColor: `${colors.surface}30` }}/>
      <div className="h-4 rounded-lg w-1/2" style={{ backgroundColor: `${colors.surface}20` }}/>
    </div>);
    return (<div className="relative">
      {isLoading && (<div className="absolute inset-0 z-10 flex items-center justify-center">
          <Skeleton />
        </div>)}
