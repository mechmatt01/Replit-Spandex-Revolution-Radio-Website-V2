...
export default function StickyPlayer() {
    ...
    return (_jsx("div", { className: `fixed bottom-2 left-4 backdrop-blur-md z-50 transition-all duration-1000 ease-in-out rounded-2xl shadow-2xl border-0 floating-player-no-focus ${isVisible
            ...
            outline: 'none'
                                ...
                                }, "aria-label": isPlaying ? "Pause radio stream" : "Play radio stream", disabled: isLoading, children: !isLoading && (_jsx(_Fragment, { children: isPlaying ? (_jsx("svg", { className: "h-15 w-15", fill: "currentColor", viewBox: "0 0 24 24", children: _jsx("rect", { x: "4", y: "4", width: "16", height: "16", rx: "4", strokeLinejoin: "round", strokeLinecap: "round" }) })) : (_jsx("svg", { className: "h-15 w-15", fill: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { d: "M8 5c0-.6.4-1 1-1 .2 0 .5.1.7.3l9 7c.8.6.8 1.8 0 2.4l-9 7c-.2.2-.5.3-.7.3-.6 0-1-.4-1-1V5z" }) })) })) })] })] }) }) }));
}
