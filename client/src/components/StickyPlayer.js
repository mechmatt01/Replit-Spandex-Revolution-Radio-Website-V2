                                    ...
                                    color: colors.textMuted
                                                        ...
                                                        e.currentTarget.style.color = isMuted
                                                            ...
                                                            : currentTheme === 'light-mode'
                                                                ? '#4b5563'
                                                                : '#9ca3af';
                                                    }, onClick: toggleMute, tabIndex: 0, onKeyDown: (e) => {
                                                        if (e.key === 'Enter' || e.key === ' ') {
                                                            e.preventDefault();
                                                            toggleMute();
                                                        }
                                                    } }), _jsxs("div", { className: "w-16 h-1 rounded-full relative flex-shrink-0", style: {
