...
export default function Navigation() {
    ...
    return (_jsxs(TooltipProvider, { children: [_jsx("nav", { className: "fixed top-0 left-0 right-0 z-50 bg-card/80 backdrop-blur-sm transition-colors duration-300 safe-area-inset-top", children: _jsxs("div", { className: "w-full relative", children: [_jsxs("div", { className: "xl:relative flex justify-between items-center h-16", style: { paddingLeft: '15px', paddingRight: '15px' }, children: [_jsxs("div", { className: "flex items-center space-x-4", children: [_jsx("div", { className: "flex items-center justify-center w-8 h-8 rounded-full cursor-pointer logo-container", style: {
                                        ...
                                        transition: 'left 0.3s ease'
                                            ...
                                            return (_jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs("button", { onClick: item.action, className: "flex items-center space-x-2 text-sm font-semibold transition-all duration-200 px-3 py-2 rounded-md hover:shadow-lg hover:scale-105 active:scale-95", style: { color: colors.text }, onMouseEnter: (e) => {
                                                        ...
                                                        return (_jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsxs("button", { onClick: item.action, className: "flex items-center space-x-3 px-4 py-3 text-sm font-semibold transition-all duration-200 whitespace-nowrap hover:rounded-lg hover:scale-105 active:scale-95 w-full", style: {
                                                        ...
                                                        height: '32px',
                                                        minWidth: '80px'
                                                    }, children: "LOGIN" }), _jsx("button", { onClick: openSignUp, className: "px-4 py-2 text-sm font-semibold rounded-lg transition-all duration-200 hover:scale-105 whitespace-nowrap", style: {
                                                        ...
                                                        height: '32px',
                                                        minWidth: '80px'
                                                    }, children: "SIGN UP" })] })) : (_jsx("div", { className: "flex items-center", children: _jsxs(DropdownMenu, { children: [_jsx(DropdownMenuTrigger, { asChild: true, children: _jsxs("button", { className: "relative flex items-center space-x-2 p-1 rounded-full transition-all duration-200 hover:scale-105", style: {
                                                                backgroundColor: 'transparent',
                                ...
                                maxWidth: '320px',
                                zIndex: 9999
                            }, children: _jsxs("div", { className: "p-4 space-y-2", children: [_jsxs("a", { href: "/music", className: "flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 hover:scale-105 active:scale-95 no-underline", style: {
                                            ...
                                            e.currentTarget.style.color = '#ffffff';
                                                    ...
                                                    e.currentTarget.style.backgroundColor = colors.primary + '20';
                                                    e.currentTarget.style.color = colors.text;
                                                }, children: [_jsx(User, { size: 16, style: { color: colors.primary } }), _jsx("span", { children: "PROFILE" })] }), _jsxs("button", { onClick: handleLogout, className: "flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full no-underline", style: {
                                                    color: colors.primary,
                                                    backgroundColor: 'transparent',
