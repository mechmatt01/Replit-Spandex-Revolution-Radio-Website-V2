  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center space-y-4">
        {/* Play/Pause and Mute Button Row - Using Flex Layout */}
        <div className="flex items-center justify-center gap-6 w-full">
          {/* Mute Button with Animated Volume Slider - Always visible to the left */}
          ...
          <Button
            ...
            disabled={isLoading}
            className="font-bold py-6 px-10 rounded-full transition-all duration-300 shadow-2xl hover:shadow-3xl transform hover:scale-110 disabled:opacity-50 disabled:transform-none text-xl border-2 flex items-center justify-center flex-shrink-0"
            style={{
