    ...
    return (_jsx("section", { className: "py-16 transition-colors duration-300", style: {
            ...
            border: 'none' // Remove borders completely
                            ...
                            border: 'none' // Remove borders
                                    ...
                                    width: "calc(50% - 4px)",
                                    zIndex: 1
                                } }), _jsx("button", { onClick: () => setActiveTab("stats"), className: "flex-1 py-2 px-4 rounded-md text-sm font-semibold transition-all duration-200 relative z-10", style: {
                                    color: activeTab === "stats" ? colors.background : colors.textMuted,
                                    border: 'none' // Remove borders
                                }, children: "Live Statistics" }), _jsx("button", { onClick: () => setActiveTab("locations"), className: "flex-1 py-2 px-4 rounded-md text-sm font-semibold transition-all duration-200 relative z-10", style: {
