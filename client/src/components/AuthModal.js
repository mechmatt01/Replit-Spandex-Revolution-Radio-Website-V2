...
export default function AuthModal({ isOpen, onClose, initialMode = "login", }) {
    ...
    return (_jsx(Dialog, { open: isOpen, onOpenChange: onClose, children: _jsxs(DialogContent, { className: "w-full max-w-md animate-in fade-in zoom-in duration-300", style: {
                backgroundColor: colors.background || 'rgba(0, 0, 0, 0.95)',
                border: `2px solid ${colors.primary}40`,
                borderRadius: '16px',
                boxShadow: `0 25px 50px -12px ${colors.primary}20`,
            }, children: [_jsxs(DialogClose, { className: "absolute right-4 top-4 rounded-full opacity-70 transition-all duration-200 hover:opacity-100 focus:outline-none disabled:pointer-events-none flex items-center justify-center cursor-pointer", style: {
                        color: colors.text,
                        ...
                        e.currentTarget.style.color = colors.text;
                                ...
                                e.currentTarget.style.borderColor = colors.primary + '40';
                                    ...
                                    : "Sign Up with Google"] }), _jsx("div", { className: "text-center", children: _jsx("button", { type: "button", onClick: switchMode, className: "text-sm transition-colors duration-200", style: { color: colors.primary }, onMouseEnter: (e) => (e.currentTarget.style.color = colors.secondary), onMouseLeave: (e) => (e.currentTarget.style.color = colors.primary), children: mode === "login"
