...
export default function SubscriptionCarousel() {
    ...
    return (<div className="relative w-full max-w-6xl mx-auto px-4">
      ...
      <div className="relative perspective-1000 subscription-carousel-container overflow-visible py-2 sm:py-4 md:py-6 lg:py-8" style={{
        ...
        {/* Navigation Buttons */}
        <button onClick={handlePrevious} className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-2 transition-all duration-300 opacity-50 hover:opacity-100" disabled={isAnimating}>
          <ChevronLeft className="w-8 h-8 text-white hover:scale-110 transition-transform drop-shadow-lg"/>
        </button>

        <button onClick={handleNext} className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-2 transition-all duration-300 opacity-50 hover:opacity-100" disabled={isAnimating}>
        ...
        <div className="flex items-center justify-center h-full relative">
          <div className="relative w-full max-w-md" style={{
            ...
            {/* Main Card */}
            <div className="relative backdrop-blur-xl rounded-3xl p-6 transform transition-all duration-500 hover:scale-105 overflow-hidden flex flex-col subscription-card" style={{
            ...
            .map((feature, index) => (<div key={index} className="flex items-center justify-center mb-2 sm:mb-3 transform transition-all duration-300" style={{
