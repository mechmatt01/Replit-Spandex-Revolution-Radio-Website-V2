...
export default function ChatButton({ onChatClick, onlineCount = 0 }) {
    ...
    return (_jsxs(Button, { onClick: onChatClick, size: "sm", variant: "ghost", className: "relative flex items-center gap-2 px-3 py-2 rounded-md transition-all duration-200 hover:scale-105", style: {
            color: colors.text,
