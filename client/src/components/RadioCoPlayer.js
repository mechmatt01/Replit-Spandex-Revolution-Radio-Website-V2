...
import { Radio as RadioIcon, ChevronDown } from "lucide-react";
import { Button } from "../components/ui/button";
import { useRadio } from "../contexts/RadioContext";
import { useTheme } from "../contexts/ThemeContext";
import ScrollingText from "../components/ScrollingText";
import InteractiveAlbumArt from "../components/InteractiveAlbumArt";
import AnimatedVolumeIcon from "../components/AnimatedVolumeIcon";
...
export default function RadioCoPlayer() {
    const { currentTrack, isPlaying, isLoading, error, togglePlayback, volume, setVolume, isMuted, toggleMute, changeStation, currentStation, isAdPlaying, adInfo, } = useRadio();
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (stationDropdownRef.current &&
                !stationDropdownRef.current.contains(event.target)) {
    ...
    const handleStationChange = async (newStation) => {
        if (audioRef.current) {
            audioRef.current.pause();
        }
        try {
    ...
    return (_jsxs("section", { className: "backdrop-blur-md rounded-2xl shadow-xl transition-all duration-1000 ease-in-out mx-auto overflow-visible", role: "region", "aria-label": "Radio player controls", style: {
            ...
            contain: 'layout'
        }, children: [_jsx("div", { className: "mb-6", children: _jsxs("div", { className: "relative", ref: stationDropdownRef, children: [_jsxs(Button, { variant: "outline", size: "sm", onClick: () => setIsStationDropdownOpen(!isStationDropdownOpen), className: "bg-card/95 backdrop-blur-sm hover:bg-card/100 transition-all duration-200 text-xs px-3 py-1", style: {
                                borderColor: colors.primary,
                                borderWidth: "2px",
                                borderRadius: "12px",
                                width: "auto",
                                '--tw-ring-color': colors.primary,
                            }, children: [_jsx(RadioIcon, { className: "w-3 h-3 mr-1", style: { color: colors.primary } }), _jsx("span", { style: { color: colors.primary }, children: selectedStation?.name || "95.5 The Beat" }), _jsx(ChevronDown, { className: `w-3 h-3 ml-1 transition-transform duration-300 ease-in-out transform ${isStationDropdownOpen ? "rotate-180" : "rotate-0"}`, style: {
                                        opacity: 0.6,
                            ...
                            }, children: _jsxs("div", { className: "p-2", children: [selectedStation && (_jsx("button", { onClick: () => handleStationChange(selectedStation), className: "w-full p-3 text-left rounded-md transition-all duration-300 hover:bg-muted/20 focus:outline-none focus:ring-0", style: {
                                            background: `linear-gradient(135deg, ${colors.primary}40, ${colors.secondary}25)`,
                                            border: `1px solid ${colors.primary}80`,
                                            boxShadow: `0 2px 8px ${colors.primary}20`,
                                        }, children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex items-center justify-center w-10 h-10 rounded-full", children: _jsx("span", { className: "text-lg", children: selectedStation.icon }) }), _jsxs("div", { className: "flex-1 min-w-0 flex items-center", children: [_jsx("div", { className: "flex-1", children: [_jsx("div", { className: "font-semibold text-sm truncate", style: {
                                                                        color: colors.text || '#ffffff',
                                                                        textShadow: '0 1px 2px rgba(0, 0, 0, 0.8)',
                                                                        fontWeight: '600'
                                                                    }, children: selectedStation.name }), _jsxs("div", { className: "text-xs truncate", style: {
                                                                        color: colors.textMuted || '#e5e7eb',
                                                                        textShadow: '0 1px 2px rgba(0, 0, 0, 0.6)'
                                                                    }, children: [selectedStation.frequency, " \u2022", " ", selectedStation.location] }), _jsx("div", { className: "text-xs truncate", style: {
                                                                        color: colors.textMuted || '#d1d5db',
                                                                        opacity: 0.9,
                                                                        textShadow: '0 1px 2px rgba(0, 0, 0, 0.5)'
                                                                    }, children: selectedStation.description })] }), isPlaying && (_jsx("div", { className: "flex items-center justify-center w-9 h-9", children: _jsx("div", { className: "flex items-center justify-center h-full", children: _jsxs("svg", { className: "w-6 h-6", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [_jsx("path", { d: "M11 5L6 9H2V15H6L11 19V5Z", fill: colors.primary }), _jsx("path", { d: "M14 9.5C15.1 10.6 15.1 12.4 14 13.5", stroke: colors.primary, strokeWidth: "1.5", className: "animate-pulse", style: {
                                                                                animation: "pulse 1.5s ease-in-out infinite",
                                                                            } }), _jsx("path", { d: "M16 7.5C18.2 9.7 18.2 13.3 16 15.5", stroke: colors.primary, strokeWidth: "1.5", className: "animate-pulse", style: {
                                                                                animation: "pulse 1.5s ease-in-out infinite",
                                                                                animationDelay: "0.3s",
                                                                            } }), _jsx("path", { d: "M18 5.5C21.3 8.8 21.3 14.2 18 17.5", stroke: colors.primary, strokeWidth: "1.5", className: "animate-pulse", style: {
                                                                                animation: "pulse 1.5s ease-in-out infinite",
                                                                                animationDelay: "0.6s",
                                                                            } })] }) }) }))] })] }) }, selectedStation.id + "-selected")), radioStations
                                        ?.filter((station) => station.id !== selectedStation?.id)
                                        .map((station) => (_jsx("button", { onClick: () => handleStationChange(station), className: "w-full p-3 text-left rounded-md transition-all duration-300 hover:bg-muted/20 focus:outline-none focus:ring-0", style: {
                                            backgroundColor: "transparent",
                                        }, children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex items-center justify-center w-10 h-10 rounded-full", style: {
                                                        background: `linear-gradient(135deg, ${colors.primary}40, ${colors.secondary}20)`,
                                                        backdropFilter: "blur(10px)",
                                                    }, children: _jsx("span", { className: "text-lg", children: station.icon }) }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("div", { className: "font-semibold text-sm truncate", style: {
                                                                color: colors.text || '#ffffff',
                                                                textShadow: '0 1px 2px rgba(0, 0, 0, 0.7)',
                                                                fontWeight: '600'
                                                            }, children: station.name }), _jsxs("div", { className: "text-xs truncate", style: {
                                                                color: colors.textMuted || '#e5e7eb',
                                                                textShadow: '0 1px 2px rgba(0, 0, 0, 0.5)'
                                                            }, children: [station.frequency, " \u2022 ", station.location] }), _jsx("div", { className: "text-xs truncate", style: {
                                                                color: colors.textMuted || '#d1d5db',
                                                                opacity: 0.9,
                                                                textShadow: '0 1px 2px rgba(0, 0, 0, 0.4)'
                                                            }, children: station.description })] })] }) }, station.id)))] }) }))] }) }), _jsxs("div", { className: "flex justify-center mb-6 relative", children: [_jsx("div", { className: `transition-all duration-1000 transform ${isTransitioning
                            ? "opacity-0 scale-75 rotate-12 blur-md"
                            : "opacity-100 scale-100 rotate-0 blur-0"}`, style: {
                        ...
                        animation: isTransitioning
                            ...
                            : "slideInFromBottom 0.8s cubic-bezier(0.68, -0.55, 0.265, 1.55)",
                                    ...
                                    boxShadow: `0 2px 8px #ff444460`,
                                        ...
                                        textAlign: "center"
                                    }, maxWidth: "90%", backgroundColor: "transparent", alignment: "center" }) }) }), currentTrack.artist &&
                            currentTrack.artist !== currentTrack.title &&
                            currentTrack.artist !== "Live Stream" &&
                            currentTrack.artist !==
                                (selectedStation?.name || "95.5 The Beat") && (_jsx("p", { className: "font-black text-2xl mb-1 transition-opacity duration-500 text-center", style: {
                                color: isAdPlaying ? '#fca5a5' : colors.text,
                                textAlign: "center"
                            }, children: currentTrack.artist })), currentTrack.album &&
                            currentTrack.album !== "New York's Hip Hop & R&B" &&
                            currentTrack.album !== "Live Stream" &&
                            currentTrack.album !== currentTrack.title &&
                            currentTrack.album !== currentTrack.artist &&
                            currentTrack.album !==
                                (selectedStation?.name || "95.5 The Beat") && (_jsx("p", { className: "text-sm font-medium mb-2 transition-opacity duration-500 text-center", style: {
                                color: isAdPlaying ? '#fecaca' : colors.textMuted,
                                textAlign: "center"
                            }, children: currentTrack.album })), currentTrack.stationName && (_jsxs("p", { className: "text-sm font-medium mb-1 transition-opacity duration-500 text-center", style: { color: colors.textMuted, textAlign: "center" }, children: [currentTrack.stationName, " \u2022 ", currentTrack.frequency] })), currentTrack.genre && (_jsx("p", { className: "text-xs font-medium transition-opacity duration-500 text-center", style: { color: colors.textMuted, textAlign: "center" }, children: currentTrack.genre })), isAdPlaying && adInfo.reason && (_jsx("p", { className: "text-red-300 text-xs font-medium mt-2 transition-opacity duration-500 text-center", children: adInfo.reason }))] }) }), _jsxs("div", { className: "flex flex-col items-center justify-center space-y-4 relative", children: [_jsx("div", { className: "flex items-center justify-center w-full", children: _jsx(Button, { onClick: handlePlayPause, disabled: isLoading, className: "w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 group shadow-lg hover:shadow-xl border-0 focus:outline-none focus:ring-0", style: {
                                background: `linear-gradient(45deg, ${colors.primary}, ${colors.secondary})`,
                                boxShadow: `0 4px 20px ${colors.primary}60`,
                                opacity: isLoading ? 0.5 : 1,
                                border: "none",
                                outline: "none",
                            }, children: isLoading ? (_jsx("div", { className: "w-7 h-7 border-2 border-t-transparent rounded-full animate-spin", style: {
                                    ...
                                    animation: "pulse 2s ease-in-out infinite",
                                }, children: _jsx("path", { d: "M8 5c0-.6.4-1 1-1 .2 0 .5.1.7.3l9 7c.8.6.8 1.8 0 2.4l-9 7c-.2.2-.5.3-.7.3-.6 0-1-.4-1-1V5z", fill: "#ffffff" }) })) }) }), isPlaying && (_jsx("div", { className: "relative transition-all duration-500 ease-in-out transform opacity-100 translate-y-0 scale-100", ref: volumeButtonRef, onMouseEnter: handleVolumeAreaMouseEnter, onMouseLeave: handleVolumeAreaMouseLeave, children: _jsxs("div", { className: "relative flex items-center justify-center pb-16", children: [_jsx(Button, { onClick: toggleMute, variant: "ghost", size: "sm", className: "rounded-full flex items-center justify-center transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-0", style: {
                                        color: isMuted
                                        ...
                                        e.currentTarget.style.backgroundColor =
                                            isMuted || volume === 0
                                                ...
                                                : currentTheme === 'light-mode'
                                                    ? "rgba(0, 0, 0, 0.05)"
                                                    : "rgba(255, 255, 255, 0.05)";
                                    }, "aria-label": isMuted ? "Unmute" : "Mute", children: _jsx(AnimatedVolumeIcon, { 
                                        isMuted: isMuted, 
                                        volume: volume, 
                                        size: 40, 
                                        className: "w-10 h-10",
                                        ...
                                        perspective: "200px",
                                    }, children: _jsxs("div", { className: "flex items-center space-x-2", children: [_jsxs("div", { className: "w-32 h-2 rounded-full relative", style: {
                                                    backgroundColor: currentTheme === 'light-mode'
                                                        ? '#d1d5db' // Light gray for light mode
                                                        : '#374151' // Dark gray for dark modes
                                                }, children: [_jsx("div", { className: "h-2 rounded-full transition-all duration-150", style: {
                                                            width: `${(isMuted ? 0 : volume) * 100}%`,
                                                            background: `linear-gradient(45deg, ${colors.primary}, ${colors.secondary})`,
                                                        } }), _jsx("input", { type: "range", min: "0", max: "100", value: (isMuted ? 0 : volume) * 100, onChange: (e) => {
                                                            const newVolume = parseInt(e.target.value) / 100;
                                                            setVolume(newVolume);
                                                            if (isMuted && newVolume > 0) {
                                                                toggleMute(); // Unmute when adjusting volume
                                                            }
                                                        }, className: "absolute inset-0 w-full h-full opacity-0 cursor-pointer focus:outline-none focus:ring-0", "aria-label": "Volume control", title: "Adjust volume", style: {
                                                            outline: 'none',
                                                            border: 'none'
                                                        } })] }), _jsxs("span", { className: "text-xs font-medium min-w-[30px] text-center", style: {
                                                    color: currentTheme === 'light-mode'
                                                        ? '#6b7280' // Gray for light mode
                                                        : '#9ca3af' // Light gray for dark modes
                                                }, children: [Math.round((isMuted ? 0 : volume) * 100), "%"] })] }) })] }) }))] }), error && (_jsx("div", { className: "mt-4 text-center text-red-400 text-sm font-medium", children: error }))] }));
}
