...
import { VolumeX, Radio as RadioIcon, ChevronDown } from "lucide-react";
    ...
    return (_jsxs("section", { className: "backdrop-blur-md rounded-2xl shadow-xl transition-all duration-1000 ease-in-out mx-auto overflow-visible", role: "region", "aria-label": "Radio player controls", style: {
            ...
            contain: 'layout'
                                ...
                                boxShadow: `0 12px 48px ${colors.primary}30, 0 0 0 1px rgba(255, 255, 255, 0.15), 0 0 24px rgba(0, 0, 0, 0.3)`,
                                        ...
                                        }, children: _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex items-center justify-center w-10 h-10 rounded-full", children: _jsx("span", { className: "text-lg", children: selectedStation.icon }) }), _jsxs("div", { className: "flex-1 min-w-0 flex items-center", children: [_jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "font-semibold text-sm truncate", style: {
