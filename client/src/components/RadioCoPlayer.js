    ...
    return (_jsxs("section", { className: "backdrop-blur-md rounded-2xl shadow-xl transition-all duration-1000 ease-in-out mx-auto overflow-visible", role: "region", "aria-label": "Radio player controls", style: {
            ...
            contain: 'layout'
                                ...
                                boxShadow: `0 12px 48px ${colors.primary}30, 0 0 0 1px rgba(255, 255, 255, 0.15), 0 0 24px rgba(0, 0, 0, 0.3)`,
                                        ...
                                        .map((station) => (_jsx("button", { onClick: () => handleStationChange(station), className: "w-full p-3 text-left rounded-md transition-all duration-300 hover:bg-muted/20 focus:outline-none", style: {
                                    ...
                                    animation: "pulse 2s ease-in-out infinite",
                                        ...
                                        perspective: "200px",
                                                    ...
                                                    backgroundColor: currentTheme === 'light-mode'
                                                        ...
                                                        }, className: "absolute inset-0 w-full h-full opacity-0 cursor-pointer", "aria-label": "Volume control", title: "Adjust volume" })] }), _jsxs("span", { className: "text-xs font-medium min-w-[30px] text-center", style: {
