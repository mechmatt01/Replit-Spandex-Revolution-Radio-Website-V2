...
export default function LiveChat({ isEnabled, onToggle, isHost = false, }) {
    ...
    if (!isAuthenticated && showLoginPrompt) {
        return (_jsx("div", { className: "fixed bottom-4 right-4 z-40", children: _jsx(Card, { className: "w-80 shadow-lg backdrop-blur-sm border-0 live-chat-card", style: {
                    ...
                    border: `1px solid ${colors.primary}30`,
                }, children: _jsxs(CardContent, { className: "p-4 relative", children: [_jsxs("button", { onClick: () => setShowLoginPrompt(false), className: "absolute right-2 top-2 rounded-full opacity-70 transition-all duration-200 hover:opacity-100 focus:outline-none disabled:pointer-events-none flex items-center justify-center cursor-pointer", style: {
                                color: colors.text,
                                ...
                                e.currentTarget.style.color = colors.text;
                            }, children: [_jsx(X, { className: "h-4 w-4" }), _jsx("span", { className: "sr-only", children: "Close" })] }), _jsxs("div", { className: "text-center space-y-3", children: [_jsx(MessageCircle, { className: "w-8 h-8 mx-auto", style: { color: colors.primary } }), _jsx("h3", { className: "font-bold text-lg", style: { color: colors.primary }, children: "Live Chat" }), _jsx("p", { className: "text-sm text-foreground", children: "Sign in to join the live chat with other metalheads!" }), _jsxs("div", { className: "space-y-2", children: [_jsx("p", { className: "text-xs text-muted-foreground", children: "\u2713 Real-time messaging \u2713 Premium community \u2713 Song requests" }), _jsxs("div", { className: "flex gap-2", children: [_jsxs(Button, { size: "sm", className: "flex-1 border-0", style: {
                                                        ...
                                                        window.dispatchEvent(event);
                                                    }, className: "flex-1 border-0", style: {
    ...
    return (_jsxs(_Fragment, { children: [!isOpen && (_jsxs(Button, { onClick: () => {
                    ...
                    boxShadow: `0 8px 32px ${colors.primary}40`,
                        ...
                        border: `1px solid ${colors.primary}30`,
                                                    ...
                                                    color: colors.text,
                                                }, maxLength: 200, disabled: isLoading }), _jsx(Button, { type: "submit", size: "sm", className: "px-3", style: {
                                                    backgroundColor: colors.primary,
                                                    color: colors.primaryText || "white",
