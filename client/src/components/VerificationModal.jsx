      ...
      <DialogContent className="sm:max-w-md" style={{
        ...
        {verified ? (<div className="text-center py-8">
            ...
            <div className="space-y-2">
              ...
              <Input id="verification-code" type="text" value={code} onChange={(e) => setCode(e.target.value.replace(/\D/g, "").slice(0, 6))} className="text-center text-2xl tracking-wider bg-black/50" style={{
                color: colors.text,
                borderColor: "#374151",
            }} onFocus={(e) => (e.currentTarget.style.borderColor = colors.primary)} onBlur={(e) => (e.currentTarget.style.borderColor = "#374151")} placeholder="000000" maxLength={6} required/>
            </div>

            <div className="flex flex-col gap-3">
              <Button type="submit" disabled={loading || code.length !== 6} className="w-full py-3 font-semibold transition-all duration-200" style={{
