...
export default function OrderConfirmation() {
    ...
    if (!orderDetails) {
        ...
        <Card className="bg-gray-900 border-gray-800 max-w-md w-full mx-4">
          <CardContent className="p-8 text-center">
            ...
            <Button onClick={() => setLocation('/')} className="w-full font-bold transition-all duration-300" style={{ backgroundColor: colors.primary }}>
              Return to Home
            </Button>
          </CardContent>
        </Card>
    ...
    return (<div className="min-h-screen bg-dark-bg py-12 px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="bg-gray-900 border-gray-800">
            ...
            <CardContent className="space-y-4">
              {orderDetails.items.map((item) => (<div key={item.id} className="flex items-center space-x-4 p-4 bg-gray-800 rounded-lg">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-gray-900 border-gray-800">
              ...
              <CardContent>
                ...
                <div className="mt-4 p-3 bg-gray-800 rounded-lg">
                  ...
                  {orderDetails.trackingNumber && (<div className="flex items-center text-sm mt-2">
            ...
            <div className="space-y-3">
              <Button onClick={handleViewOrder} className="w-full font-bold transition-all duration-300" style={{ backgroundColor: colors.primary }}>
                <Package className="h-4 w-4 mr-2"/>
                View Order in Account
              </Button>
              <Button onClick={handleContinueShopping} variant="outline" className="w-full font-bold transition-all duration-300 border-gray-600 text-gray-300 hover:bg-gray-800">
