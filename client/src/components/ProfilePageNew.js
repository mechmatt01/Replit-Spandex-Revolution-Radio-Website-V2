...
export default function ProfilePage() {
    ...
    return (_jsxs("div", { className: "min-h-screen pt-20", style: { backgroundColor: colors.background }, children: [_jsx("div", { className: "max-w-7xl mx-auto px-4 py-8", children: _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-8", children: [_jsx("div", { className: "lg:col-span-1", children: _jsx(Card, { className: "border-2 shadow-xl overflow-hidden", style: {
                        ...
                        backgroundColor: isDarkMode ? 'rgba(0, 0, 0, 0.95)' : 'rgba(255, 255, 255, 0.95)',
                        borderColor: `${colors.primary}40`,
                    }, children: [_jsxs(AlertDialogHeader, { children: [_jsx(AlertDialogTitle, { className: "text-xl font-black", style: { color: colors.text }, children: "Cancel Subscription" }), _jsxs(AlertDialogDescription, { style: { color: `${colors.text}80` }, children: [_jsx(AlertCircle, { className: "inline mr-2", size: 16 }), "Are you sure you want to cancel your subscription? You'll lose access to premium features at the end of your billing cycle."] })] }), _jsxs(AlertDialogFooter, { children: [_jsx(AlertDialogCancel, { style: { color: colors.text }, children: "Keep Subscription" }), _jsx(AlertDialogAction, { onClick: handleCancelSubscription, className: "bg-red-600 hover:bg-red-700 text-white", children: "Cancel Subscription" })] })] }) }), _jsx(AlertDialog, { open: showLogoutDialog, onOpenChange: setShowLogoutDialog, children: _jsxs(AlertDialogContent, { style: {
                        backgroundColor: isDarkMode ? 'rgba(0, 0, 0, 0.95)' : 'rgba(255, 255, 255, 0.95)',
                        borderColor: `${colors.primary}40`,
                    }, children: [_jsxs(AlertDialogHeader, { children: [_jsx(AlertDialogTitle, { className: "text-xl font-black", style: { color: colors.text }, children: "Confirm Logout" }), _jsx(AlertDialogDescription, { style: { color: `${colors.text}80` }, children: "Are you sure you want to log out of your account?" })] }), _jsxs(AlertDialogFooter, { children: [_jsx(AlertDialogCancel, { style: { color: colors.text }, children: "Cancel" }), _jsx(AlertDialogAction, { onClick: handleLogout, className: "bg-red-600 hover:bg-red-700 text-white", children: "Logout" })] })] }) })] }));
}
