      ...
      <CardContent className="p-4 flex flex-col h-full">
        ...
        <div className="mt-auto">
          {product.variants.length > 1 && (<div className="relative mb-3">
              <select value={selectedVariant.id} onChange={(e) => setSelectedVariant(product.variants.find((v) => v.id === e.target.value))} className="w-full p-2 bg-dark-bg/50 text-white rounded appearance-none pr-8" style={{ borderColor: colors.primary }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            color: '#9ca3af'
              ...
              {product.variants.length > 1 && (<div className="mb-4">
                  ...
                  <select value={selectedVariant.id} onChange={(e) => setSelectedVariant(product.variants.find((v) => v.id === e.target.value))} className="w-full p-2 bg-dark-bg border-dark-border text-white placeholder-gray-500 focus:border-metal-orange rounded">
                    {product.variants.map((variant) => (<option key={variant.id} value={variant.id} disabled={!variant.available}>
                        {variant.title} {!variant.available && "(Out of Stock)"}
                      </option>))}
                  </select>
