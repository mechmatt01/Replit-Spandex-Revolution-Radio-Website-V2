    ...
    return (<div className="flex items-center gap-2">
      ...
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        <PopoverTrigger asChild>
          <Button variant="ghost" size="sm" className="flex items-center gap-2 hover:bg-opacity-20" style={{
        ...
        <PopoverContent className="w-80 p-0 border-0 max-h-[80vh] overflow-hidden" style={{
          ...
          <Card className="border-0 shadow-xl" style={{ backgroundColor: colors.surface }}>
            ...
            return (<Button key={themeKey} onClick={() => handleThemeClick(themeKey, themeConfig)} variant="ghost" className={`w-full justify-start p-3 h-auto hover:bg-opacity-20 ${isActive ? "ring-2" : ""} ${isLocked ? "opacity-75" : ""}`} style={{
                    ...
                    color: "#ffffff",
                      ...
                      <div className="flex-1 text-left min-w-0">
                        ...
                        color: colors.primary,
                          ...
                          {isPremium && (<Star className="w-4 h-4 flex-shrink-0" style={{
                        color: "#ffd700",
                        fill: "#ffd700",
                        filter: isLocked
            ...
            border: "1px solid rgba(255, 255, 255, 0.2)",
                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="flex gap-2 mt-4">
                      <Button onClick={() => setShowPremiumDialog(false)} variant="ghost" className="flex-1 text-white border border-white/30 hover:bg-white/20 font-semibold px-4 py-2 text-sm" style={{
