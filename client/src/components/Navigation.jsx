        ...
        <div className="w-full relative">
          <div className="xl:relative flex justify-between items-center h-16" style={{ paddingLeft: '15px', paddingRight: '15px' }}>
            ...
            return (<Tooltip key={item.id}>
                    <TooltipTrigger asChild>
                      <button onClick={item.action} className="flex items-center space-x-2 text-sm font-semibold transition-all duration-200 px-3 py-2 rounded-md hover:shadow-md" style={{ color: colors.text }} onMouseEnter={(e) => {
              ...
              <div className="relative" ref={dropdownRef}>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="flex items-center space-x-1 text-sm font-semibold transition-all duration-200 px-3 py-2 rounded-md hover:shadow-md" style={{
            ...
            transition: 'transform 0.2s ease'
                ...
                return (<Tooltip key={item.id}>
                          <TooltipTrigger asChild>
                            <button onClick={item.action} className="flex items-center space-x-3 px-4 py-3 text-sm font-semibold transition-all duration-200 whitespace-nowrap hover:rounded-lg w-full" style={{
                        color: colors.text
                    }} onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor = colors.primary + '20';
                        e.currentTarget.style.color = 'white';
            ...
            <div className="hidden xl:flex items-center space-x-1 absolute right-4 top-1/2 transform -translate-y-1/2">
              ...
              {!isAuthenticated ? (<div className="flex items-center space-x-3">
                ...
                '--ring-offset-color': isDarkMode ? '#000000' : '#ffffff',
                            ...
                            {!user?.profileImageUrl && (<User size={20} className="text-white"/>)}
                          </div>
                    ...
                    <DropdownMenuContent align="end" className="w-64 p-2 mt-2 shadow-2xl border-2" style={{
            ...
            <div className="xl:hidden flex items-center space-x-3">
              <MetalThemeSwitcher />
              <button ref={menuRef} onClick={() => setIsOpen(!isOpen)} className="p-2 rounded-lg transition-colors duration-200 flex items-center justify-center" style={{
          ...
          {isOpen && (<div ref={mobileDropdownRef} className="xl:hidden absolute top-full right-4 bg-black/90 backdrop-blur-md border rounded-xl animate-in slide-in-from-top-2 duration-300 shadow-xl" style={{
              ...
              <div className="p-4 space-y-2">
                {/* Music Link */}
                <a href="/music" className="flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 no-underline" style={{
                color: colors.text,
                backgroundColor: 'transparent',
                display: 'flex',
                textDecoration: 'none'
                ...
                {/* Schedule Link */}
                <a href="/#schedule" className="flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 no-underline" style={{
                color: colors.text,
                backgroundColor: 'transparent',
                display: 'flex',
                textDecoration: 'none'
                ...
                {/* Support Us Link */}
                <a href="/#subscribe" className="flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 no-underline" style={{
                color: colors.text,
                backgroundColor: 'transparent',
                display: 'flex',
                textDecoration: 'none'
                ...
                {/* Submissions Link */}
                <a href="/#submissions" className="flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 no-underline" style={{
                color: colors.text,
                backgroundColor: 'transparent',
                display: 'flex',
                textDecoration: 'none'
                ...
                {/* Contact Link */}
                <a href="/#contact" className="flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 no-underline" style={{
                color: colors.text,
                backgroundColor: 'transparent',
                display: 'flex',
                textDecoration: 'none'
                ...
                {/* Listen Map Link */}
                <a href="/#map" className="flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 no-underline" style={{
                color: colors.text,
                backgroundColor: 'transparent',
                display: 'flex',
                textDecoration: 'none'
                ...
                {/* Features Link */}
                <a href="/#features" className="flex items-center space-x-3 px-4 py-3 text-base font-semibold rounded-lg transition-all duration-200 w-full hover:bg-opacity-20 no-underline" style={{
                color: colors.text,
                backgroundColor: 'transparent',
                display: 'flex',
                textDecoration: 'none'
