...
export function AccessibilityProvider({ children }) {
    ...
    useEffect(() => {
        const detectPreferences = () => {
            ...
            document.documentElement.style.setProperty('--animation-duration', reduceMotion ? '0.01ms' : '300ms');
            document.documentElement.style.setProperty('--transition-duration', reduceMotion ? '0.01ms' : '200ms');
            if (highContrast) {
