...
export default function FullWidthGlobeMap() {
  ...
  const [hoveredListener, setHoveredListener] = useState<ListenerData | null>(null);
  ...
  const [liveListeners, setLiveListeners] = useState<ListenerData[]>([
    { id: '1', city: 'New York', country: 'USA', lat: 40.7128, lng: -74.0060, isActive: true, lastSeen: new Date(), username: 'MetalHead92' },
    { id: '2', city: 'London', country: 'UK', lat: 51.5074, lng: -0.1278, isActive: true, lastSeen: new Date(), username: 'RockLover' },
    { id: '3', city: 'Tokyo', country: 'Japan', lat: 35.6762, lng: 139.6503, isActive: true, lastSeen: new Date(), username: 'MetalSamurai' },
    { id: '4', city: 'Sydney', country: 'Australia', lat: -33.8688, lng: 151.2093, isActive: true, lastSeen: new Date(), username: 'OzMetalFan' },
    { id: '5', city: 'Berlin', country: 'Germany', lat: 52.5200, lng: 13.4050, isActive: true, lastSeen: new Date(), username: 'TeutonRocker' },
    { id: '6', city: 'São Paulo', country: 'Brazil', lat: -23.5558, lng: -46.6396, isActive: true, lastSeen: new Date(), username: 'BrazilMetal' },
    { id: '7', city: 'Mumbai', country: 'India', lat: 19.0760, lng: 72.8777, isActive: true, lastSeen: new Date(), username: 'IndianRocker' },
    { id: '8', city: 'Moscow', country: 'Russia', lat: 55.7558, lng: 37.6173, isActive: true, lastSeen: new Date(), username: 'RussianMetal' },
    { id: '9', city: 'Toronto', country: 'Canada', lat: 43.6532, lng: -79.3832, isActive: true, lastSeen: new Date(), username: 'CanadianRocker' },
    { id: '10', city: 'Stockholm', country: 'Sweden', lat: 59.3293, lng: 18.0686, isActive: true, lastSeen: new Date(), username: 'NordicMetal' },
    { id: '11', city: 'Mexico City', country: 'Mexico', lat: 19.4326, lng: -99.1332, isActive: true, lastSeen: new Date(), username: 'MexicanMetal' },
    { id: '12', city: 'Cape Town', country: 'South Africa', lat: -33.9249, lng: 18.4241, isActive: true, lastSeen: new Date(), username: 'AfricanRock' },
    { id: '13', city: 'Paris', country: 'France', lat: 48.8566, lng: 2.3522, isActive: true, lastSeen: new Date(), username: 'FrenchMetal' },
    { id: '14', city: 'Buenos Aires', country: 'Argentina', lat: -34.6118, lng: -58.3960, isActive: true, lastSeen: new Date(), username: 'ArgentinaMetal' },
    { id: '15', city: 'Amsterdam', country: 'Netherlands', lat: 52.3676, lng: 4.9041, isActive: true, lastSeen: new Date(), username: 'DutchRocker' },
  ]);
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute inset-0 rounded-full overflow-hidden">
                        <div className="absolute w-12 h-16 bg-green-600 rounded-full opacity-70 top-20 left-16" /> {/* North America */}
                        <div className="absolute w-8 h-12 bg-green-600 rounded-full opacity-70 top-32 left-24" /> {/* South America */}
                        <div className="absolute w-14 h-12 bg-green-600 rounded-full opacity-70 top-16 left-40" /> {/* Europe/Africa */}
                        <div className="absolute w-16 h-14 bg-green-600 rounded-full opacity-70 top-24 left-56" /> {/* Asia */}
                        <div className="absolute w-8 h-8 bg-green-600 rounded-full opacity-70 top-52 left-60" /> {/* Australia */}
                      </div>
                      ...
                      {!isLoading && activeListeners.map((listener) => {
                        const spherePos = latLngToSphere(listener.lat, listener.lng, 160);
                        ...
                        return (
                          ...
                          >
                            ...
                            {hoveredListener?.id === listener.id && (
                              ...
                              >
                                <div className="font-semibold">{listener.username || 'Anonymous'}</div>
                                <div>{listener.city}, {listener.country}</div>
                                <div className="text-xs opacity-75">
                                  Last seen: {listener.lastSeen.toLocaleTimeString()}
                                </div>
                              </div>
                            )}
                          </div>
