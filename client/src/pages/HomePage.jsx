...
export default function HomePage() {
    ...
    return (<div className="min-h-screen transition-colors duration-300" style={{
      ...
      <FadeInView direction="up" delay={0}>
        <section id="subscribe" className="py-20 transition-colors duration-300" style={{ backgroundColor: colors.background }}>
