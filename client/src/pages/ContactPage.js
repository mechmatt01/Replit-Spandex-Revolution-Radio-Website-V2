...
export default function ContactPage() {
    ...
    return (_jsx("div", { className: "min-h-screen transition-colors duration-300", style: {
            ...
            color: colors.text
                                        ...
                                        }, children: "Contact" }), _jsx("p", { className: "text-lg font-semibold", style: {
                                            color: currentTheme === 'light-mode' ? 'rgba(0, 0, 0, 0.7)' : colors.textMuted
                                        }, children: "Get in touch with the station." })] }), _jsx("div", { className: "text-center", children: _jsx("p", { className: "text-lg", style: { color: colors.textMuted }, children: "Contact content will be displayed here." }) })] }) }) }) }) }));
}
