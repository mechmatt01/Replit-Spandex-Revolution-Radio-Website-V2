          ...
          <div className="max-w-4xl mx-auto mt-8">
            <div className="bg-black/90 backdrop-blur-md rounded-lg p-6 border border-orange-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Hot 97 is New York City's premier hip hop and R&B radio station.
                Broadcasting live 24/7, Hot 97 brings you the latest hits,
                exclusive interviews, and the hottest tracks from your favorite
                artists.
              </p>
