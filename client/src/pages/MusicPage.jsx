          ...
          <div className="max-w-4xl mx-auto mb-6">
            <div className="flex justify-center">
              <div className="relative">
                <button onClick={() => setIsStationDropdownOpen(!isStationDropdownOpen)} className="flex items-center space-x-2 px-6 py-3 rounded-lg transition-all duration-200 font-semibold text-white" style={{
            ...
            transition: 'transform 0.2s ease'
                ...
                {/* Station Dropdown */}
                {isStationDropdownOpen && (<div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 py-2 rounded-lg shadow-xl border backdrop-blur-md z-50" style={{
                backgroundColor: colors.background === '#000000' ? 'rgba(0, 0, 0, 0.95)' : 'rgba(255, 255, 255, 0.95)',
                borderColor: colors.primary + '40',
                minWidth: '200px'
            }}>
                    {stations.map((station) => (<button key={station} onClick={() => {
