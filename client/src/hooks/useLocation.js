...
export function useLocation() {
    ...
    const requestLocation = async () => {
        ...
        try {
            ...
            try {
                const response = await fetch(`https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${locationData.lat}&longitude=${locationData.lng}&localityLanguage=en`);
                if (response.ok) {
