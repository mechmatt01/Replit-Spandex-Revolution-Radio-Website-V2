...
class MetadataFetcher {
    static instance;
    cache = new Map();
    CACHE_DURATION = 5000; // 5 seconds for fresh metadata
    static getInstance() {
    ...
    async fetchIHeartMetadata(stationId, stationName) {
        try {
    ...
    async fetchIHeartWebScraping(stationId, stationName) {
        try {
    ...
    async fetchStreamTheWorldMetadata(callSign, stationName) {
        try {
    ...
    async fetchSomaFMMetadata(channel, stationName) {
        try {
    ...
    async fetchAlternativeMetadata(callSign, stationName) {
        try {
    ...
    async fetchCurrentTrackFromItunes(stationName) {
        try {
    ...
    getSearchTermsForStation(stationName) {
    ...
    async fetchArtworkFromItunes(title, artist) {
        try {
