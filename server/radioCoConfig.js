...
export function isCommercial(metadata) {
    const title = metadata.title?.toLowerCase() || "";
    const artist = metadata.artist?.toLowerCase() || "";
    return (title.includes("in a commercial") ||
...
export function extractCompanyName(metadata) {
    ...
    else if (artist.length > title.length &&
...
export function getClearbitLogo(companyName) {
