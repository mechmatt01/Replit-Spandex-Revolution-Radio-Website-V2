          ...
          >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                ...
                >
                  Check out our programming schedule and upcoming shows.
                </p>
              </div>
              
              {/* Schedule content will go here - this should match what's on the homepage */}
              <div className="text-center">
                <p className="text-lg mb-8">
                  Schedule content will be displayed here, matching the homepage schedule section.
                </p>
              </div>
            </div>
          </section>
